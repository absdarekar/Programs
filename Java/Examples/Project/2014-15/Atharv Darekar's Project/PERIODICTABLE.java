...
{    
    Wait obj=new Wait();
    boolean e=false;
    void Periodictable()throws IOException
    {
        BufferedReader A=new BufferedReader(new InputStreamReader(System.in));
        String atomicnumber,eorc;
        System.out.println("");
        System.out.println("**********************************WELCOME TO PERIODIC TABLE PROGRAMMED BY ATHARV DAREKAR**********************************");
        System.out.println("");
        obj.Wait1();
        do
        {
            System.out.println();
            System.out.println("ENTER THE ATOMIC NUMBER OF THE ELEMENT FOR INFORMATION");
            atomicnumber=A.readLine();
            switch (atomicnumber)
            {               
                case "1":
                ...
                break;
                case "103":
                System.out.println("ELEMENT-LAWRENCIUM (Lr)");
                ...
                break;
                case "108":
                System.out.println("ELEMENT-HASSIUM (Hs)");
                ...
                break;
                case "109":
                System.out.println("ELEMENT-MEITNERIUM (Mt)");
                ...
                break;
                case "117": 
                System.out.println("ELEMENT-UNUNSEPTIUM (Uuh)");
                ...
                break;
                case "118":
                System.out.println("ELEMENT-UNUNOCTIUM (Uuo)");
            ...
            System.out.println("PRESS 'ENTER' TO CONTINUE ELSE ENTER 'EXIT' TO EXIT PERIODIC TABLE");
            eorc=A.readLine();
            if(eorc.equals("EXIT"))
                e=true;
        }while(e==false);
